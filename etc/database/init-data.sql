...
insert into public.news (news_id, content, create_timestamp, image, name, soft_delete, category_id)
values (1, 'This is the news content...', null,
        'https://alkemy-java-ot231.s3.amazonaws.com/workshop.jpg', 'Last Week Workshop', false, 1);

insert into public.members (member_id, name, facebook_url, instagram_url, linkedin_url, image,
